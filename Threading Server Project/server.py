...
class MockBusAPI:
    ...
    ROUTE_DETAILS = {
        ...
        "B1": ["ประตู 4", "โรงอาหารเรียนรวม 1", "อาคารบรรณสาร", "ประตู 4"],
        "B2": ["สนามกีฬา", "อาคารบรรณสาร", "โรงพยาบาล ม.ท.ส.", "สนามกีฬา"],
        "C1": ["โรงพยาบาล ม.ท.ส.", "ประตู 1", "ประตู 2", "ประตู 3", "โรงพยาบาล ม.ท.ส."]
    }
